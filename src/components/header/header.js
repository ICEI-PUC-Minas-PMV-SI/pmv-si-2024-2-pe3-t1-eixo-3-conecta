    ...
    template.innerHTML = `
        ...
        <header class="header-desktop">
            ...
            <div class="buttons-header-wrapper">
                ...
                <a id="perfil-da-ong" style="${pathName.includes('pagina-do-voluntario.html') ? "": "display: none"}" href=${getPagePath("cadastrar-ong")}  class="header-button area-da-ong-button"><img class="dot-black" src="${rootPath}/assets/icons/dot-black.png">PERFIL</a>
